/**************************************************************************
 *
 * $Id: nonlinear-solver.h,v 1.15 2011/03/26 12:56:40 patrick Exp $
 *
...
namespace mudfas {
  ...
  class NonLinearSolver : public MultiGridSolver {
  public:

    NonLinearSolver(int nargs, char* args[]);
  ...
  private:
    ...
    void gaussSeidelNewton(Field& phi, Field& rhs, Field& F, Field& dF,
                           int kgrid, Range& I, Range& J);
#elif (DIM==3)

    void gaussSeidelNewton(Field& phi, Field& rhs, Field& F, Field& dF,
                           int kgrid, Range &I, Range &J, Range &K);
#endif

    virtual void getNonLinearFunction(Field &phi, Field &F, int kgrid) const=0;
    virtual void getNonLinearFunctionAndDerivative(Field &phi, Field &F,
        Field &dF, int kgrid) const=0;
  };
